  ...
  Future<List<Person>?> getPersons(String state) async {
    ...
    try {
      ...
      if (response.statusCode.toString() == "200") {
        List<Person> oersons = Person().getListFromJson(response.body);
