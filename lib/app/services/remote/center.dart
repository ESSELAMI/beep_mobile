...
import 'package:beep_mobile/base/services/center.dart';
import 'package:beep_mobile/utils/api/urls.dart';
import 'package:http/http.dart' as http;

class CentreService extends BaseCentreService {
  Future<List<Centre>?> getCentres() async {
    ...
    try {
      ...
      if (response.statusCode.toString() == "200") {
        List<Centre> centres = Centre().getListFromJson(response.body);
        return centres;
      }
      return null;
    } catch (error) {
